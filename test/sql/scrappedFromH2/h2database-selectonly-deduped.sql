...
SELECT (TIMESTAMP WITH TIME ZONE '2010-01-01 10:00:00+01' + 1) A, (1 + TIMESTAMP WITH TIME ZONE '2010-01-01 10:00:00+01') B;
...
SELECT * FROM ( SELECT ID, ARRAY_CONTAINS(A, 1L), ARRAY_CONTAINS(A, 2L), ARRAY_CONTAINS(A, 3L), ARRAY_CONTAINS(A, 4L) FROM TEST );
...
SELECT * FROM (SELECT CAST(BIRTH AS DATE) B FROM TEST GROUP BY CAST(BIRTH AS DATE)) A WHERE A.B >= '2006-05-05';
...
SELECT * FROM (SELECT X * X, Y FROM (SELECT A + 5, B FROM (VALUES (1, 2)) V(A, B) ) T(X, Y) );
...
SELECT * FROM (VALUES(1, 'A'), (2, 'B')) T1(A, B) JOIN (VALUES(2, 'C'), (3, 'D')) T2(A, C) USING (A);
SELECT * FROM (VALUES(1, 'A'), (2, 'B')) T1(A, B) LEFT JOIN (VALUES(2, 'C'), (3, 'D')) T2(A, C) USING (A);
SELECT * FROM (VALUES(1, 'A'), (2, 'B')) T1(A, B) NATURAL JOIN (VALUES(2, 'C'), (3, 'D')) T2(A, C);
SELECT * FROM (VALUES(1, 'A'), (2, 'B')) T1(A, B) RIGHT JOIN (VALUES(2, 'C'), (3, 'D')) T2(A, C) USING (A);
...
SELECT *, ARRAY_AGG(ID ORDER BY ID) OVER (ORDER BY "VALUE" RANGE BETWEEN 1 PRECEDING AND UNBOUNDED FOLLOWING) A1, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" RANGE BETWEEN UNBOUNDED PRECEDING AND 1 FOLLOWING) A2 FROM TEST;
SELECT *, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN 0 PRECEDING AND 0 FOLLOWING) N, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN 0 PRECEDING AND 0 FOLLOWING EXCLUDE TIES) T, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN 1 PRECEDING AND 0 FOLLOWING EXCLUDE TIES) T1 FROM TEST;
SELECT *, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN 1 PRECEDING AND 0 PRECEDING) P, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN 0 FOLLOWING AND 1 FOLLOWING) F FROM TEST;
SELECT *, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN UNBOUNDED PRECEDING AND 1 PRECEDING) U_P, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN 2 PRECEDING AND 1 PRECEDING) P, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN 1 FOLLOWING AND 2 FOLLOWING) F, ARRAY_AGG(ID ORDER BY ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN 1 FOLLOWING AND UNBOUNDED FOLLOWING) U_F FROM TEST;
...
SELECT *, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" ROWS BETWEEN 1 PRECEDING AND 1 FOLLOWING) R_ID, ARRAY_AGG("VALUE") OVER (ORDER BY "VALUE" ROWS BETWEEN 1 PRECEDING AND 1 FOLLOWING) R_V, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" RANGE BETWEEN 1 PRECEDING AND 1 FOLLOWING) V_ID, ARRAY_AGG("VALUE") OVER (ORDER BY "VALUE" RANGE BETWEEN 1 PRECEDING AND 1 FOLLOWING) V_V, ARRAY_AGG("VALUE") OVER (ORDER BY "VALUE" DESC RANGE BETWEEN 1 PRECEDING AND 1 FOLLOWING) V_V_R, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN 1 PRECEDING AND 1 FOLLOWING) G_ID, ARRAY_AGG("VALUE") OVER (ORDER BY "VALUE" GROUPS BETWEEN 1 PRECEDING AND 1 FOLLOWING) G_V FROM TEST;
...
SELECT *, FIRST_VALUE("VALUE") OVER (ORDER BY ID) FIRST, FIRST_VALUE("VALUE") RESPECT NULLS OVER (ORDER BY ID) FIRST_N, FIRST_VALUE("VALUE") IGNORE NULLS OVER (ORDER BY ID) FIRST_NN, LAST_VALUE("VALUE") OVER (ORDER BY ID) LAST, LAST_VALUE("VALUE") RESPECT NULLS OVER (ORDER BY ID) LAST_N, LAST_VALUE("VALUE") IGNORE NULLS OVER (ORDER BY ID) LAST_NN FROM TEST FETCH FIRST 6 ROWS ONLY;
SELECT *, FIRST_VALUE("VALUE") OVER (ORDER BY ID) FIRST, FIRST_VALUE("VALUE") RESPECT NULLS OVER (ORDER BY ID) FIRST_N, FIRST_VALUE("VALUE") IGNORE NULLS OVER (ORDER BY ID) FIRST_NN, LAST_VALUE("VALUE") OVER (ORDER BY ID) LAST, LAST_VALUE("VALUE") RESPECT NULLS OVER (ORDER BY ID) LAST_N, LAST_VALUE("VALUE") IGNORE NULLS OVER (ORDER BY ID) LAST_NN FROM TEST WHERE ID > 1 FETCH FIRST 3 ROWS ONLY;
SELECT *, FIRST_VALUE("VALUE") OVER (PARTITION BY CATEGORY ORDER BY ID) FIRST, LAST_VALUE("VALUE") OVER (PARTITION BY CATEGORY ORDER BY ID) LAST, NTH_VALUE("VALUE", 2) OVER (PARTITION BY CATEGORY ORDER BY ID) NTH FROM TEST ORDER BY ID;
SELECT *, LAST_VALUE(ID) OVER W FROM TEST WINDOW W AS (PARTITION BY CATEGORY ORDER BY ID RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW);
SELECT *, LEAD("VALUE") OVER (ORDER BY ID) LD, LEAD("VALUE") RESPECT NULLS OVER (ORDER BY ID) LD_N, LEAD("VALUE") IGNORE NULLS OVER (ORDER BY ID) LD_NN, LAG("VALUE") OVER (ORDER BY ID) LG, LAG("VALUE") RESPECT NULLS OVER (ORDER BY ID) LG_N, LAG("VALUE") IGNORE NULLS OVER (ORDER BY ID) LG_NN FROM TEST;
SELECT *, LEAD("VALUE", 0) OVER (ORDER BY ID) LD, LEAD("VALUE", 0) RESPECT NULLS OVER (ORDER BY ID) LD_N, LEAD("VALUE", 0) IGNORE NULLS OVER (ORDER BY ID) LD_NN, LAG("VALUE", 0) OVER (ORDER BY ID) LG, LAG("VALUE", 0) RESPECT NULLS OVER (ORDER BY ID) LG_N, LAG("VALUE", 0) IGNORE NULLS OVER (ORDER BY ID) LG_NN FROM TEST;
SELECT *, LEAD("VALUE", 1) OVER (ORDER BY ID) LD, LEAD("VALUE", 1) RESPECT NULLS OVER (ORDER BY ID) LD_N, LEAD("VALUE", 1) IGNORE NULLS OVER (ORDER BY ID) LD_NN, LAG("VALUE", 1) OVER (ORDER BY ID) LG, LAG("VALUE", 1) RESPECT NULLS OVER (ORDER BY ID) LG_N, LAG("VALUE", 1) IGNORE NULLS OVER (ORDER BY ID) LG_NN FROM TEST;
SELECT *, LEAD("VALUE", 2) OVER (ORDER BY ID) LD, LEAD("VALUE", 2) RESPECT NULLS OVER (ORDER BY ID) LD_N, LEAD("VALUE", 2) IGNORE NULLS OVER (ORDER BY ID) LD_NN, LAG("VALUE", 2) OVER (ORDER BY ID) LG, LAG("VALUE", 2) RESPECT NULLS OVER (ORDER BY ID) LG_N, LAG("VALUE", 2) IGNORE NULLS OVER (ORDER BY ID) LG_NN FROM TEST;
SELECT *, LEAD("VALUE", 2, 1111.0) OVER (ORDER BY ID) LD, LEAD("VALUE", 2, 1111.0) RESPECT NULLS OVER (ORDER BY ID) LD_N, LEAD("VALUE", 2, 1111.0) IGNORE NULLS OVER (ORDER BY ID) LD_NN, LAG("VALUE", 2, 1111.0) OVER (ORDER BY ID) LG, LAG("VALUE", 2, 1111.0) RESPECT NULLS OVER (ORDER BY ID) LG_N, LAG("VALUE", 2, 1111.0) IGNORE NULLS OVER (ORDER BY ID) LG_NN FROM TEST;
SELECT *, NTH_VALUE("VALUE", 2) OVER (ORDER BY ID) NTH, NTH_VALUE("VALUE", 2) FROM FIRST OVER (ORDER BY ID) NTH_FF, NTH_VALUE("VALUE", 2) FROM LAST OVER (ORDER BY ID) NTH_FL, NTH_VALUE("VALUE", 2) RESPECT NULLS OVER (ORDER BY ID) NTH_N, NTH_VALUE("VALUE", 2) FROM FIRST RESPECT NULLS OVER (ORDER BY ID) NTH_FF_N, NTH_VALUE("VALUE", 2) FROM LAST RESPECT NULLS OVER (ORDER BY ID) NTH_FL_N, NTH_VALUE("VALUE", 2) IGNORE NULLS OVER (ORDER BY ID) NTH_NN, NTH_VALUE("VALUE", 2) FROM FIRST IGNORE NULLS OVER (ORDER BY ID) NTH_FF_NN, NTH_VALUE("VALUE", 2) FROM LAST IGNORE NULLS OVER (ORDER BY ID) NTH_FL_NN FROM TEST FETCH FIRST 6 ROWS ONLY;
SELECT *, NTH_VALUE("VALUE", 2) OVER(ORDER BY ID) F, NTH_VALUE("VALUE", 2) OVER(ORDER BY ID RANGE BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) F_U_C, NTH_VALUE("VALUE", 2) OVER(ORDER BY ID RANGE BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING) F_C_U, NTH_VALUE("VALUE", 2) OVER(ORDER BY ID RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) F_U_U, NTH_VALUE("VALUE", 2) FROM LAST OVER(ORDER BY ID) L, NTH_VALUE("VALUE", 2) FROM LAST OVER(ORDER BY ID RANGE BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) L_U_C, NTH_VALUE("VALUE", 2) FROM LAST OVER(ORDER BY ID RANGE BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING) L_C_U, NTH_VALUE("VALUE", 2) FROM LAST OVER(ORDER BY ID RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) L_U_U FROM TEST ORDER BY ID;
SELECT *, ROW_NUMBER() OVER () RN, ROUND(PERCENT_RANK() OVER (), 2) PR, ROUND(CUME_DIST() OVER (), 2) CD, ROW_NUMBER() OVER (ORDER BY ID) RNO, RANK() OVER (ORDER BY ID) RKO, DENSE_RANK() OVER (ORDER BY ID) DRO, ROUND(PERCENT_RANK() OVER (ORDER BY ID), 2) PRO, ROUND(CUME_DIST() OVER (ORDER BY ID), 2) CDO FROM TEST;
SELECT *, ROW_NUMBER() OVER (ORDER BY CATEGORY) RN, RANK() OVER (ORDER BY CATEGORY) RK, DENSE_RANK() OVER (ORDER BY CATEGORY) DR, ROUND(PERCENT_RANK() OVER (ORDER BY CATEGORY), 2) PR, ROUND(CUME_DIST() OVER (ORDER BY CATEGORY), 2) CD FROM TEST;
SELECT *, ROW_NUMBER() OVER (PARTITION BY CATEGORY ORDER BY ID) RN, RANK() OVER (PARTITION BY CATEGORY ORDER BY ID) RK, DENSE_RANK() OVER (PARTITION BY CATEGORY ORDER BY ID) DR, ROUND(PERCENT_RANK() OVER (PARTITION BY CATEGORY ORDER BY ID), 2) PR, ROUND(CUME_DIST() OVER (PARTITION BY CATEGORY ORDER BY ID), 2) CD FROM TEST QUALIFY RN = 3;
SELECT *, ROW_NUMBER() OVER (PARTITION BY CATEGORY ORDER BY ID) RN, RANK() OVER (PARTITION BY CATEGORY ORDER BY ID) RK, DENSE_RANK() OVER (PARTITION BY CATEGORY ORDER BY ID) DR, ROUND(PERCENT_RANK() OVER (PARTITION BY CATEGORY ORDER BY ID), 2) PR, ROUND(CUME_DIST() OVER (PARTITION BY CATEGORY ORDER BY ID), 2) CD FROM TEST;
SELECT *, ROW_NUMBER() OVER W FROM TEST;
SELECT *, ROW_NUMBER() OVER W RN, RANK() OVER W RK, DENSE_RANK() OVER W DR, ROUND(PERCENT_RANK() OVER W, 2) PR, ROUND(CUME_DIST() OVER W, 2) CD FROM TEST WINDOW W AS (PARTITION BY CATEGORY ORDER BY ID) QUALIFY ROW_NUMBER() OVER W = 2;
SELECT *, ROW_NUMBER() OVER W1, ROW_NUMBER() OVER W2 FROM TEST WINDOW W1 AS (W2 ORDER BY ID), W2 AS (PARTITION BY CATEGORY ORDER BY ID DESC);
SELECT 0 AND TRUE;
SELECT 0x1234567890abL;
SELECT 0x1L;
select 0 from (( select 0 as f from dual u1 where null in (?, ?, ?, ?, ?) ) union all ( select u2.f from ( select 0 as f from ( select 0 from dual u2f1f1 where now() = ? ) u2f1 ) u2 )) where f = 12345;
SELECT 1 "A""B""""C""";
...
SELECT A = B, NULLIF(A, B), CASE WHEN A = B THEN NULL ELSE A END FROM (VALUES (1, (1, NULL), (1, NULL)), (2, (1, NULL), (2, NULL)), (3, (2, NULL), (1, NULL)), (4, (1, 1), (1, 2)) ) T(N, A, B) ORDER BY N;
...
SELECT A, B, C, ROW_NUMBER() OVER (PARTITION BY A, B) N FROM VALUES (1, 1, 1), (1, 1, 2), (1, 2, 3), (2, 1, 4) T(A, B, C);
...
SELECT A, MAX(B) M, FIRST_VALUE(A) OVER (ORDER BY A ROWS BETWEEN MAX(B) - 1 FOLLOWING AND UNBOUNDED FOLLOWING) F FROM VALUES (1, 1), (1, 1), (2, 1), (2, 2), (3, 1) V(A, B) GROUP BY A;
SELECT A, ROW_NUMBER() OVER (ORDER BY B) R FROM (VALUES (1, 2), (2, 1), (3, 3)) T(A, B);
SELECT A, SUM(A) OVER W SUM FROM (VALUES 1, 2) T(A) WINDOW W AS (ORDER BY A);
SELECT A, SUM(S) OVER (ORDER BY S) FROM (SELECT A, SUM(B) FROM (VALUES (1, 2), (1, 3), (3, 5), (3, 10)) V(A, B) GROUP BY A) S(A, S);
...
SELECT ARRAY_AGG(ARRAY_AGG(ID ORDER BY ID)) FILTER (WHERE NAME > 'b') OVER (PARTITION BY NAME), NAME FROM TEST GROUP BY NAME ORDER BY NAME;
SELECT ARRAY_AGG(ARRAY_AGG(ID ORDER BY ID)) FILTER (WHERE NAME > 'c') OVER () FROM TEST GROUP BY NAME ORDER BY NAME;
SELECT ARRAY_AGG(ARRAY_AGG(ID ORDER BY ID)) FILTER (WHERE NAME > 'c') OVER (PARTITION BY NAME), NAME FROM TEST GROUP BY NAME ORDER BY NAME;
...
SELECT ARRAY_AGG(ARRAY_AGG(ID ORDER BY ID)) OVER (PARTITION BY NAME), NAME FROM TEST WHERE ID <> 5 GROUP BY NAME HAVING ARRAY_AGG(ID ORDER BY ID)[1] > 1 QUALIFY ARRAY_AGG(ARRAY_AGG(ID ORDER BY ID)) OVER (PARTITION BY NAME) <> ARRAY[ARRAY[3]];
SELECT ARRAY_AGG(DISTINCT A ORDER BY B) FROM (VALUES (4, 3), (5, 1), (5, 2)) T(A, B);
SELECT ARRAY_AGG(ID ORDER BY ID) FILTER (WHERE ID < 3 OR ID > 4) OVER (ORDER BY ID ROWS BETWEEN 1 PRECEDING AND 1 FOLLOWING) A, ID FROM TEST ORDER BY ID;
SELECT ARRAY_AGG(ID ORDER BY ID) FILTER (WHERE ID < 3 OR ID > 4) OVER (PARTITION BY NAME) A, ARRAY_AGG(ID ORDER BY ID) FILTER (WHERE ID < 3 OR ID > 4) OVER (PARTITION BY NAME ORDER BY ID) AO, ID, NAME FROM TEST ORDER BY ID;
...
SELECT ARRAY_AGG(ID ORDER BY ID) OVER(PARTITION BY NAME ORDER BY ID DESC) A, ARRAY_AGG(ID) OVER(PARTITION BY NAME ORDER BY ID DESC) D, NAME FROM TEST;
SELECT ARRAY_AGG(ID ORDER BY ID), NAME FROM TEST GROUP BY NAME;
SELECT ARRAY_AGG(ID) OVER (ORDER BY G RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) D, ARRAY_AGG(ID) OVER (ORDER BY G RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW) R, ARRAY_AGG(ID) OVER (ORDER BY G RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE GROUP) G, ARRAY_AGG(ID) OVER (ORDER BY G RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE TIES) T, ARRAY_AGG(ID) OVER (ORDER BY G RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE NO OTHERS) N FROM TEST;
SELECT ARRAY_AGG(ID) OVER (ORDER BY V NULLS FIRST RANGE BETWEEN 1 FOLLOWING AND UNBOUNDED FOLLOWING) A, ID, V FROM VALUES (1, 1), (2, NULL), (3, 2) T(ID, V) ORDER BY V NULLS FIRST;
SELECT ARRAY_AGG(ID) OVER (ORDER BY V NULLS FIRST RANGE BETWEEN 1 PRECEDING AND UNBOUNDED FOLLOWING) A, ID, V FROM VALUES (1, 1), (2, NULL), (3, 2) T(ID, V) ORDER BY V NULLS FIRST;
SELECT ARRAY_AGG(ID) OVER (ORDER BY V NULLS FIRST RANGE BETWEEN UNBOUNDED PRECEDING AND 1 FOLLOWING) A, ID, V FROM VALUES (1, 1), (2, NULL), (3, 2) T(ID, V) ORDER BY V NULLS FIRST;
SELECT ARRAY_AGG(ID) OVER (ORDER BY V NULLS FIRST RANGE BETWEEN UNBOUNDED PRECEDING AND 1 PRECEDING) A, ID, V FROM VALUES (1, 1), (2, NULL), (3, 2) T(ID, V) ORDER BY V NULLS FIRST;
SELECT ARRAY_AGG(ID) OVER (ORDER BY V NULLS LAST RANGE BETWEEN 1 FOLLOWING AND UNBOUNDED FOLLOWING) A, ID, V FROM VALUES (1, 1), (2, NULL), (3, 2) T(ID, V) ORDER BY V NULLS LAST;
SELECT ARRAY_AGG(ID) OVER (ORDER BY V NULLS LAST RANGE BETWEEN 1 PRECEDING AND UNBOUNDED FOLLOWING) A, ID, V FROM VALUES (1, 1), (2, NULL), (3, 2) T(ID, V) ORDER BY V NULLS LAST;
SELECT ARRAY_AGG(ID) OVER (ORDER BY V NULLS LAST RANGE BETWEEN UNBOUNDED PRECEDING AND 1 FOLLOWING) A, ID, V FROM VALUES (1, 1), (2, NULL), (3, 2) T(ID, V) ORDER BY V NULLS LAST;
SELECT ARRAY_AGG(ID) OVER (ORDER BY V NULLS LAST RANGE BETWEEN UNBOUNDED PRECEDING AND 1 PRECEDING) A, ID, V FROM VALUES (1, 1), (2, NULL), (3, 2) T(ID, V) ORDER BY V NULLS LAST;
...
SELECT ARRAY_AGG(T) OVER (ORDER BY T RANGE BETWEEN INTERVAL '1' DAY PRECEDING AND CURRENT ROW) C, ARRAY_AGG(T) OVER (ORDER BY T RANGE BETWEEN INTERVAL '2' HOUR PRECEDING AND INTERVAL '1' HOUR PRECEDING) P, T FROM VALUES (TIME '00:00:00'), (TIME '01:30:00') TEST(T) ORDER BY T;
...
SELECT B, CASE B WHEN IS TRUE THEN 1 WHEN IS FALSE THEN 0 WHEN IS UNKNOWN THEN -1 END FROM (VALUES TRUE, FALSE, UNKNOWN) T(B);
SELECT B, NOT B IS NOT UNKNOWN, NOT N IS NOT UNKNOWN, NOT B IS NOT FALSE, NOT N IS NOT FALSE, NOT B IS NOT TRUE, NOT N IS NOT TRUE FROM TEST;
SELECT BITAND('AA', 'BB');
...
SELECT C, SUM(I) S, LEAD(SUM(I)) OVER (ORDER BY SUM(I)) L FROM VALUES (1, 1), (2, 1), (4, 2), (8, 2) T(I, C) GROUP BY C;
...
SELECT CH.ID CH_ID1, CH.NAME CH_NAME2, CL.ID CL_ID3, CL.NAME CL_NAME4 FROM CHILDREN CH, CLASSES CL WHERE CH.CLASS = CL.ID;
...
SELECT COLUMN_NAME, DATA_TYPE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TEST' ORDER BY ORDINAL_POSITION;
SELECT COLUMN_NAME, DATA_TYPE, DATETIME_PRECISION FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TEST' ORDER BY ORDINAL_POSITION;
SELECT COLUMN_NAME, DATA_TYPE, NUMERIC_PRECISION, NUMERIC_PRECISION_RADIX, NUMERIC_SCALE, DECLARED_DATA_TYPE, DECLARED_NUMERIC_PRECISION, DECLARED_NUMERIC_SCALE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TEST' ORDER BY ORDINAL_POSITION;
SELECT COLUMN_NAME, DATA_TYPE, NUMERIC_PRECISION, NUMERIC_SCALE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'T2' ORDER BY ORDINAL_POSITION;
SELECT COLUMN_NAME, DATA_TYPE_SQL('PUBLIC', 'A', 'TABLE', DTD_IDENTIFIER) TYPE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'A' ORDER BY ORDINAL_POSITION;
...
SELECT CONSTRAINT_NAME, CONSTRAINT_TYPE, TABLE_NAME, IS_DEFERRABLE, INITIALLY_DEFERRED FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS WHERE CONSTRAINT_CATALOG = DATABASE() AND CONSTRAINT_SCHEMA = SCHEMA() AND TABLE_CATALOG = DATABASE() AND TABLE_SCHEMA = SCHEMA() ORDER BY TABLE_NAME, CONSTRAINT_NAME;
SELECT CONSTRAINT_NAME, INDEX_NAME FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS;
SELECT CONSTRAINT_NAME, TABLE_NAME, COLUMN_NAME, ORDINAL_POSITION FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE WHERE CONSTRAINT_NAME = 'TEST_UNI_C';
SELECT CONSTRAINT_NAME, TABLE_NAME, COLUMN_NAME, ORDINAL_POSITION, POSITION_IN_UNIQUE_CONSTRAINT FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE WHERE CONSTRAINT_CATALOG = DATABASE() AND CONSTRAINT_SCHEMA = SCHEMA() AND TABLE_CATALOG = DATABASE() AND TABLE_SCHEMA = SCHEMA() ORDER BY TABLE_NAME, CONSTRAINT_NAME, ORDINAL_POSITION;
...
SELECT CORR(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
...
SELECT COUNT(*) FROM PARENT, CHILD A, CHILD B, CHILD C, CHILD D, CHILD E, CHILD F, CHILD G, CHILD H WHERE AID=A.ID AND BID=B.ID AND CID=C.ID AND DID=D.ID AND EID=E.ID AND FID=F.ID AND GID=G.ID AND HID=H.ID;
...
SELECT COUNT(ID) OVER (ORDER BY NAME) AS NR, A.ID AS ID FROM (SELECT ID, NAME FROM TEST ORDER BY NAME) AS A;
...
SELECT COVAR_POP(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
SELECT COVAR_SAMP(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
...
SELECT D, EXTRACT(ISO_DAY_OF_WEEK FROM D) D1, EXTRACT(ISODOW FROM D) D2 FROM (VALUES DATE '2019-02-03', DATE '2019-02-04') V(D);
SELECT D, ISO_YEAR(D) Y1, EXTRACT(ISO_WEEK_YEAR FROM D) Y2, EXTRACT(ISO_YEAR FROM D) Y3, EXTRACT(ISOYEAR FROM D) Y4 FROM (VALUES DATE '2017-01-01', DATE '2017-01-02') V(D);
...
SELECT DATA_TYPE_SQL(S, O, T, I) FROM (VALUES (NULL, 'C', 'CONSTANT', 'TYPE'), ('X', 'C', 'CONSTANT', 'TYPE'), ('PUBLIC', NULL, 'CONSTANT', 'TYPE'), ('PUBLIC', 'X', 'CONSTANT', 'TYPE'), ('PUBLIC', 'C', NULL, 'TYPE'), (NULL, 'D', 'DOMAIN', 'TYPE'), ('X', 'D', 'DOMAIN', 'TYPE'), ('PUBLIC', NULL, 'DOMAIN', 'TYPE'), ('PUBLIC', 'X', 'DOMAIN', 'TYPE'), ('PUBLIC', 'D', NULL, 'TYPE'), (NULL, 'T', 'TABLE', '1'), ('X', 'T', 'TABLE', '1'), ('PUBLIC', NULL, 'TABLE', '1'), ('PUBLIC', 'X', 'TABLE', '1'), ('PUBLIC', 'T', NULL, '1'), (NULL, 'R_1', 'ROUTINE', '1'), ('X', 'R_1', 'ROUTINE', '1'), ('PUBLIC', NULL, 'ROUTINE', '1'), ('PUBLIC', 'R_0', 'ROUTINE', '1'), ('PUBLIC', 'R_2', 'ROUTINE', '1'), ('PUBLIC', 'R_Z', 'ROUTINE', '1'), ('PUBLIC', 'X', 'ROUTINE', '1'), ('PUBLIC', 'X_1', 'ROUTINE', '1'), ('PUBLIC', 'R_1', NULL, '1'), ('PUBLIC', 'T', 'X', '1') ) T(S, O, T, I);
SELECT DATE '-1000102';
...
SELECT DATEDIFF('MICROSECOND', '2006-01-01 00:00:00.0000000', '2006-01-01 00:00:00.123456789'), DATEDIFF('MCS', '2006-01-01 00:00:00.0000000', '2006-01-01 00:00:00.123456789'), DATEDIFF('MCS', '2006-01-01 00:00:00.0000000', '2006-01-02 00:00:00.123456789');
...
SELECT DATEDIFF('NANOSECOND', '2006-01-01 00:00:00.0000000', '2006-01-01 00:00:00.123456789'), DATEDIFF('NS', '2006-01-01 00:00:00.0000000', '2006-01-01 00:00:00.123456789'), DATEDIFF('NS', '2006-01-01 00:00:00.0000000', '2006-01-02 00:00:00.123456789');
...
SELECT DATEDIFF('TIMEZONE_HOUR', TIME WITH TIME ZONE '10:00:00+01', TIME WITH TIME ZONE '12:00:00+02');
SELECT DATEDIFF('TIMEZONE_HOUR', TIMESTAMP WITH TIME ZONE '2010-01-01 10:00:00+01', TIMESTAMP WITH TIME ZONE '2012-02-02 12:00:00+02');
SELECT DATEDIFF('TIMEZONE_MINUTE', TIME WITH TIME ZONE '10:00:00+01:15', TIME WITH TIME ZONE '12:00:00+02');
SELECT DATEDIFF('TIMEZONE_MINUTE', TIMESTAMP WITH TIME ZONE '2010-01-01 10:00:00+01:15', TIMESTAMP WITH TIME ZONE '2012-02-02 12:00:00+02');
SELECT DATEDIFF('TIMEZONE_SECOND', TIMESTAMP WITH TIME ZONE '1880-01-01 10:00:00-07:52:58', TIMESTAMP WITH TIME ZONE '1890-02-02 12:00:00-08');
...
SELECT DENSE_RANK(1) WITHIN GROUP (ORDER BY V) R1, DENSE_RANK(3) WITHIN GROUP (ORDER BY V) R3, DENSE_RANK(7) WITHIN GROUP (ORDER BY V) R7 FROM TEST;
...
SELECT ENVELOPE(V), ENVELOPE(V) FILTER (WHERE V <> 'POINT(3 1)') FILTERED1, ENVELOPE(V) FILTER (WHERE V <> 'POINT(1 2)') FILTERED2 FROM TEST;
SELECT ESTIMATED_ENVELOPE('TEST', 'V');
SELECT EVERY(X>4) FROM SYSTEM_RANGE(1,6);
SELECT EXTRACT (MICROSECOND FROM TIME '10:00:00.123456789'), EXTRACT (MCS FROM TIMESTAMP '2015-01-01 11:22:33.987654321');
SELECT EXTRACT (NANOSECOND FROM TIME '10:00:00.123456789'), EXTRACT (NS FROM TIMESTAMP '2015-01-01 11:22:33.987654321');
...
SELECT I, BITGET(CAST((0xC5 - 0x100) AS TINYINT), I), BITGET(CAST(0xC5 AS SMALLINT), I), BITGET(CAST(0xC5 AS INTEGER), I), BITGET(CAST(0xC5 AS BIGINT), I), BITGET(CAST(X'C5' AS VARBINARY), I), BITGET(CAST(X'C5' AS BINARY), I) FROM (VALUES -1, 0, 1, 4, 9, 99) T(I);
SELECT I, C, COUNT(I) OVER (PARTITION BY C) CNT FROM VALUES (1, 1), (2, 1), (3, 2), (4, 2), (5, 2) T(I, C);
SELECT I, LSHIFT(CAST(-128 AS TINYINT), I), LSHIFT(CAST(1 AS TINYINT), I), ULSHIFT(CAST(-128 AS TINYINT), I), ULSHIFT(CAST(1 AS TINYINT), I) FROM (VALUES -111, -8, -7, -1, 0, 1, 7, 8, 111) T(I) ORDER BY I;
SELECT I, LSHIFT(CAST(-2147483648 AS INTEGER), I), LSHIFT(CAST(1 AS INTEGER), I), ULSHIFT(CAST(-2147483648 AS INTEGER), I), ULSHIFT(CAST(1 AS INTEGER), I) FROM (VALUES -111, -32, -31, -1, 0, 1, 31, 32, 111) T(I) ORDER BY I;
SELECT I, LSHIFT(CAST(-32768 AS SMALLINT), I), LSHIFT(CAST(1 AS SMALLINT), I), ULSHIFT(CAST(-32768 AS SMALLINT), I), ULSHIFT(CAST(1 AS SMALLINT), I) FROM (VALUES -111, -16, -15, -1, 0, 1, 15, 16, 111) T(I) ORDER BY I;
SELECT I, LSHIFT(CAST(-9223372036854775808 AS BIGINT), I), LSHIFT(CAST(1 AS BIGINT), I), ULSHIFT(CAST(-9223372036854775808 AS BIGINT), I), ULSHIFT(CAST(1 AS BIGINT), I) FROM (VALUES -111, -64, -63, -1, 0, 1, 63, 64, 111) T(I) ORDER BY I;
SELECT I, LSHIFT(X'80ABCD09', I) FROM (VALUES -33, -32, -31, -17, -16, -15, -1, 0, 1, 15, 16, 17, 31, 32, 33) T(I) ORDER BY I;
SELECT I, ROTATELEFT(CAST(0x6d3f AS SMALLINT), I) L, ROTATERIGHT(CAST(0x6d3f AS SMALLINT), I) R FROM (VALUES -16, -15, -2, -1, 0, 1, 2, 15, 16) T(I) ORDER BY I;
SELECT I, ROTATELEFT(CAST(0x7302abe53d12e45f AS BIGINT), I) L, ROTATERIGHT(CAST(0x7302abe53d12e45f AS BIGINT), I) R FROM (VALUES -64, -63, -2, -1, 0, 1, 2, 63, 64) T(I) ORDER BY I;
SELECT I, ROTATELEFT(CAST(0x7d AS TINYINT), I) L, ROTATERIGHT(CAST(0x7d AS TINYINT), I) R FROM (VALUES -8, -7, -2, -1, 0, 1, 2, 7, 8) T(I) ORDER BY I;
SELECT I, ROTATELEFT(CAST(0x7d12e43c AS INTEGER), I) L, ROTATERIGHT(CAST(0x7d12e43c AS INTEGER), I) R FROM (VALUES -32, -31, -2, -1, 0, 1, 2, 31, 32) T(I) ORDER BY I;
SELECT I, ROTATELEFT(CAST(X'ABCD' AS BINARY(2)), I) L, ROTATERIGHT(CAST(X'ABCD' AS BINARY(2)), I) R FROM (VALUES -16, -15, -8, -1, 0, 1, 8, 15, 16) T(I) ORDER BY I;
SELECT I, ROTATELEFT(X'ABCD', I) L, ROTATERIGHT(X'ABCD', I) R FROM (VALUES -16, -15, -8, -1, 0, 1, 8, 15, 16) T(I) ORDER BY I;
SELECT I, RSHIFT(CAST(-128 AS TINYINT), I), RSHIFT(CAST(1 AS TINYINT), I), URSHIFT(CAST(-128 AS TINYINT), I), URSHIFT(CAST(1 AS TINYINT), I) FROM (VALUES -111, -8, -7, -1, 0, 1, 7, 8, 111) T(I) ORDER BY I;
SELECT I, RSHIFT(CAST(-2147483648 AS INTEGER), I), RSHIFT(CAST(1 AS INTEGER), I), URSHIFT(CAST(-2147483648 AS INTEGER), I), URSHIFT(CAST(1 AS INTEGER), I) FROM (VALUES -111, -32, -31, -1, 0, 1, 31, 32, 111) T(I) ORDER BY I;
SELECT I, RSHIFT(CAST(-32768 AS SMALLINT), I), RSHIFT(CAST(1 AS SMALLINT), I), URSHIFT(CAST(-32768 AS SMALLINT), I), URSHIFT(CAST(1 AS SMALLINT), I) FROM (VALUES -111, -16, -15, -1, 0, 1, 15, 16, 111) T(I) ORDER BY I;
SELECT I, RSHIFT(CAST(-9223372036854775808 AS BIGINT), I), RSHIFT(CAST(1 AS BIGINT), I), URSHIFT(CAST(-9223372036854775808 AS BIGINT), I), URSHIFT(CAST(1 AS BIGINT), I) FROM (VALUES -111, -64, -63, -1, 0, 1, 63, 64, 111) T(I) ORDER BY I;
SELECT I, RSHIFT(X'80ABCD09', I) FROM (VALUES -33, -32, -31, -17, -16, -15, -1, 0, 1, 15, 16, 17, 31, 32, 33) T(I) ORDER BY I;
SELECT I, V, COUNT(V) OVER W C, COUNT(DISTINCT V) OVER W D FROM VALUES (1, 1), (2, 1), (3, 1), (4, 1), (5, 2), (6, 2), (7, 3) T(I, V) WINDOW W AS (ORDER BY I);
SELECT I, V, SUM(V) OVER W S, SUM(DISTINCT V) OVER W D FROM VALUES (1, 1), (2, 1), (3, 1), (4, 1), (5, 2), (6, 2), (7, 3) T(I, V) WINDOW W AS (ORDER BY I);
...
SELECT ID, "VALUE", ARRAY_AGG(ID ORDER BY ID) OVER (ORDER BY ID RANGE BETWEEN UNBOUNDED PRECEDING AND "VALUE" FOLLOWING) RG, ARRAY_AGG(ID ORDER BY ID) OVER (ORDER BY ID RANGE BETWEEN "VALUE" PRECEDING AND UNBOUNDED FOLLOWING) RGR, ARRAY_AGG(ID ORDER BY ID) OVER (ORDER BY ID ROWS BETWEEN UNBOUNDED PRECEDING AND "VALUE" FOLLOWING) R, ARRAY_AGG(ID ORDER BY ID) OVER (ORDER BY ID ROWS BETWEEN "VALUE" PRECEDING AND UNBOUNDED FOLLOWING) RR FROM TEST;
SELECT ID, "VALUE", ARRAY_AGG(ID ORDER BY ID) OVER (PARTITION BY "VALUE" ORDER BY ID ROWS BETWEEN "VALUE" / 3 PRECEDING AND "VALUE" / 3 FOLLOWING) A, ARRAY_AGG(ID ORDER BY ID) OVER (PARTITION BY "VALUE" ORDER BY ID ROWS BETWEEN UNBOUNDED PRECEDING AND "VALUE" / 3 FOLLOWING) AP, ARRAY_AGG(ID ORDER BY ID) OVER (PARTITION BY "VALUE" ORDER BY ID ROWS BETWEEN "VALUE" / 3 PRECEDING AND UNBOUNDED FOLLOWING) AF FROM TEST;
SELECT ID, "VALUE", ARRAY_AGG(ID) OVER (ORDER BY "VALUE" RANGE BETWEEN 1 FOLLOWING AND 1 FOLLOWING EXCLUDE CURRENT ROW) A FROM TEST;
SELECT ID, "VALUE", ARRAY_AGG(ID) OVER (ORDER BY "VALUE" RANGE BETWEEN 2 PRECEDING AND 1 PRECEDING EXCLUDE CURRENT ROW) A FROM TEST;
SELECT ID, "VALUE", ARRAY_AGG(ID) OVER (ORDER BY "VALUE" RANGE BETWEEN 2 PRECEDING AND 1 PRECEDING) A FROM TEST;
SELECT ID, "VALUE", ARRAY_AGG(ID) OVER (ORDER BY "VALUE" ROWS BETWEEN 2 PRECEDING AND 2 FOLLOWING EXCLUDE GROUP) G, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" ROWS BETWEEN 2 PRECEDING AND 2 FOLLOWING EXCLUDE TIES) T FROM TEST;
SELECT ID, "VALUE", ARRAY_AGG(ID) OVER (ORDER BY "VALUE" ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) CP, ARRAY_AGG(ID ORDER BY ID) OVER (ORDER BY "VALUE" ROWS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING) CF, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" RANGE BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) RP, ARRAY_AGG(ID ORDER BY ID) OVER (ORDER BY "VALUE" RANGE BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING) RF, ARRAY_AGG(ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) GP, ARRAY_AGG(ID ORDER BY ID) OVER (ORDER BY "VALUE" GROUPS BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING) GF FROM TEST;
SELECT ID, "VALUE", ARRAY_AGG(ID) OVER(ORDER BY "VALUE" ROWS BETWEEN 1 FOLLOWING AND 2 FOLLOWING EXCLUDE GROUP) G FROM TEST ORDER BY ID FETCH FIRST 3 ROWS ONLY;
SELECT ID, "VALUE", ARRAY_AGG(ID) OVER(ORDER BY "VALUE" ROWS BETWEEN 2 PRECEDING AND 1 PRECEDING EXCLUDE GROUP) G FROM TEST ORDER BY ID FETCH FIRST 3 ROWS ONLY;
...
SELECT ID, CAST(XT AS NUMBER(10,1)), CAST(X_SM AS NUMBER(10,1)), CAST(XB AS NUMBER(10,1)), CAST(XD AS NUMBER(10,1)), CAST(XD2 AS NUMBER(10,1)), CAST(XR AS NUMBER(10,1)) FROM TEST;
SELECT ID, CAST(XTS AS DATE) TS2D, CAST(XTS AS TIME(9)) TS2T, CAST(XD AS TIMESTAMP) D2TS FROM TEST;
SELECT ID, CAST(X_SM AS BIGINT) S2L, CAST(XT AS BIGINT) B2L, CAST(XD2 AS BIGINT) D2L, CAST(XR AS BIGINT) R2L FROM TEST;
SELECT ID, CATEGORY, FIRST_VALUE(ID) OVER (ORDER BY ID ROWS BETWEEN CATEGORY FOLLOWING AND UNBOUNDED FOLLOWING) F, LAST_VALUE(ID) OVER (ORDER BY ID ROWS BETWEEN CURRENT ROW AND CATEGORY FOLLOWING) L, NTH_VALUE(ID, 2) OVER (ORDER BY ID ROWS BETWEEN CATEGORY FOLLOWING AND UNBOUNDED FOLLOWING) N FROM TEST ORDER BY ID;
SELECT ID, CATEGORY, NTH_VALUE(CATEGORY, 1) OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE GROUP) F1, NTH_VALUE(CATEGORY, 2) OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE GROUP) F2, NTH_VALUE(CATEGORY, 5) OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE GROUP) F5, NTH_VALUE(CATEGORY, 5) FROM LAST OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE GROUP) L5, NTH_VALUE(CATEGORY, 2) FROM LAST OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE GROUP) L2, NTH_VALUE(CATEGORY, 1) FROM LAST OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE GROUP) L1 FROM TEST ORDER BY ID;
SELECT ID, CATEGORY, NTH_VALUE(CATEGORY, 1) OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE TIES) F1, NTH_VALUE(CATEGORY, 2) OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE TIES) F2, NTH_VALUE(CATEGORY, 5) OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE TIES) F5, NTH_VALUE(CATEGORY, 5) FROM LAST OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE TIES) L5, NTH_VALUE(CATEGORY, 2) FROM LAST OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE TIES) L2, NTH_VALUE(CATEGORY, 1) FROM LAST OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE TIES) L1 FROM TEST ORDER BY ID;
SELECT ID, CATEGORY, NTH_VALUE(CATEGORY, 2) FROM LAST OVER (ORDER BY CATEGORY RANGE BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING) C2, NTH_VALUE(CATEGORY, 3) FROM LAST OVER (ORDER BY CATEGORY RANGE BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING) C3, NTH_VALUE(CATEGORY, 2) FROM LAST OVER (ORDER BY CATEGORY RANGE BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW) FROM TEST OFFSET 10 ROWS;
SELECT ID, CATEGORY, NTH_VALUE(CATEGORY, 2) FROM LAST OVER (ORDER BY CATEGORY RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING EXCLUDE CURRENT ROW) C FROM TEST OFFSET 10 ROWS;
SELECT ID, CATEGORY, NTH_VALUE(CATEGORY, 2) OVER (ORDER BY CATEGORY ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) C, NTH_VALUE(CATEGORY, 2) OVER (ORDER BY CATEGORY ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW EXCLUDE CURRENT ROW) FROM TEST FETCH FIRST 3 ROWS ONLY;
...
SELECT ID, SUM(ID) OVER (ORDER BY ID) S, SUM(ID) OVER (ORDER BY ID RANGE BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) S_U_C, SUM(ID) OVER (ORDER BY ID RANGE BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING) S_C_U, SUM(ID) OVER (ORDER BY ID RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) S_U_U FROM (SELECT X ID FROM SYSTEM_RANGE(1, 8));
...
SELECT ID_A <> ID_B, SQL_A, SQL_B FROM (VALUES ( DB_OBJECT_ID('CONSTANT', 'PUBLIC', 'A'), DB_OBJECT_ID('CONSTANT', 'PUBLIC', 'B'), DB_OBJECT_SQL('CONSTANT', 'PUBLIC', 'A'), DB_OBJECT_SQL('CONSTANT', 'PUBLIC', 'B') )) T(ID_A, ID_B, SQL_A, SQL_B);
SELECT ID_A <> ID_B, SQL_A, SQL_B FROM (VALUES ( DB_OBJECT_ID('DOMAIN', 'PUBLIC', 'A'), DB_OBJECT_ID('DOMAIN', 'PUBLIC', 'B'), DB_OBJECT_SQL('DOMAIN', 'PUBLIC', 'A'), DB_OBJECT_SQL('DOMAIN', 'PUBLIC', 'B') )) T(ID_A, ID_B, SQL_A, SQL_B);
SELECT ID_A <> ID_B, SQL_A, SQL_B FROM (VALUES ( DB_OBJECT_ID('ROLE', 'A'), DB_OBJECT_ID('ROLE', 'B'), DB_OBJECT_SQL('ROLE', 'A'), DB_OBJECT_SQL('ROLE', 'B') )) T(ID_A, ID_B, SQL_A, SQL_B);
SELECT ID_A <> ID_B, SQL_A, SQL_B FROM (VALUES ( DB_OBJECT_ID('ROUTINE', 'PUBLIC', 'A'), DB_OBJECT_ID('ROUTINE', 'PUBLIC', 'B'), DB_OBJECT_SQL('ROUTINE', 'PUBLIC', 'A'), DB_OBJECT_SQL('ROUTINE', 'PUBLIC', 'B') )) T(ID_A, ID_B, SQL_A, SQL_B);
SELECT ID_A <> ID_B, SQL_A, SQL_B FROM (VALUES ( DB_OBJECT_ID('SCHEMA', 'A'), DB_OBJECT_ID('SCHEMA', 'B'), DB_OBJECT_SQL('SCHEMA', 'A'), DB_OBJECT_SQL('SCHEMA', 'B') )) T(ID_A, ID_B, SQL_A, SQL_B);
SELECT ID_A <> ID_B, SQL_A, SQL_B FROM (VALUES ( DB_OBJECT_ID('SEQUENCE', 'PUBLIC', 'A'), DB_OBJECT_ID('SEQUENCE', 'PUBLIC', 'B'), DB_OBJECT_SQL('SEQUENCE', 'PUBLIC', 'A'), DB_OBJECT_SQL('SEQUENCE', 'PUBLIC', 'B') )) T(ID_A, ID_B, SQL_A, SQL_B);
SELECT ID_A <> ID_B, SQL_A, SQL_B FROM (VALUES ( DB_OBJECT_ID('USER', 'A'), DB_OBJECT_ID('USER', 'B'), DB_OBJECT_SQL('USER', 'A'), DB_OBJECT_SQL('USER', 'B') )) T(ID_A, ID_B, SQL_A, SQL_B);
...
SELECT INDEX_NAME, TABLE_NAME, COLUMN_NAME, ORDINAL_POSITION, IS_UNIQUE FROM INFORMATION_SCHEMA.INDEX_COLUMNS WHERE INDEX_NAME = 'TEST_IDX' ORDER BY ORDINAL_POSITION;
...
SELECT MODE() WITHIN GROUP (ORDER BY V) OVER () MA, MODE() WITHIN GROUP (ORDER BY V DESC) OVER () MD, MODE() WITHIN GROUP (ORDER BY V) OVER (ORDER BY V) MWA, MODE() WITHIN GROUP (ORDER BY V DESC) OVER (ORDER BY V) MWD, V FROM TEST;
...
SELECT NR FROM (SELECT COUNT(ID) OVER (ORDER BY NAME) AS NR, A.ID AS ID FROM (SELECT ID, NAME FROM TEST ORDER BY NAME) AS A) AS B WHERE B.ID = 1;
...
SELECT NULL AND NULL, NULL AND FALSE, NULL AND TRUE, FALSE AND NULL, FALSE AND FALSE, FALSE AND TRUE, TRUE AND NULL, TRUE AND FALSE, TRUE AND TRUE;
SELECT NULL IS NOT NULL;
SELECT NULL IS NOT UNKNOWN, FALSE IS NOT UNKNOWN, TRUE IS NOT UNKNOWN, NULL IS NOT FALSE, FALSE IS NOT FALSE, TRUE IS NOT FALSE, NULL IS NOT TRUE, FALSE IS NOT TRUE, TRUE IS NOT TRUE;
SELECT NULL IS NULL;
SELECT NULL IS UNKNOWN, FALSE IS UNKNOWN, TRUE IS UNKNOWN, NULL IS FALSE, FALSE IS FALSE, TRUE IS FALSE, NULL IS TRUE, FALSE IS TRUE, TRUE IS TRUE;
SELECT NULL OR NULL, NULL OR FALSE, NULL OR TRUE, FALSE OR NULL, FALSE OR FALSE, FALSE OR TRUE, TRUE OR NULL, TRUE OR FALSE, TRUE OR TRUE;
...
SELECT RANK(1) WITHIN GROUP (ORDER BY V) FILTER (WHERE FALSE) R, DENSE_RANK(1) WITHIN GROUP (ORDER BY V) FILTER (WHERE FALSE) D, PERCENT_RANK(1) WITHIN GROUP (ORDER BY V) FILTER (WHERE FALSE) P, CUME_DIST(1) WITHIN GROUP (ORDER BY V) FILTER (WHERE FALSE) C FROM VALUES (1) T(V);
SELECT RANK(1) WITHIN GROUP (ORDER BY V) OVER () R1, RANK(3) WITHIN GROUP (ORDER BY V) OVER () R3, RANK(7) WITHIN GROUP (ORDER BY V) OVER () R7, V FROM TEST ORDER BY V;
SELECT RANK(1) WITHIN GROUP (ORDER BY V) OVER (ORDER BY V) R1, RANK(3) WITHIN GROUP (ORDER BY V) OVER (ORDER BY V) R3, RANK(7) WITHIN GROUP (ORDER BY V) OVER (ORDER BY V) R7, RANK(7) WITHIN GROUP (ORDER BY V) FILTER (WHERE V <> 2) OVER (ORDER BY V) F7, V FROM TEST ORDER BY V;
SELECT RANK(1) WITHIN GROUP (ORDER BY V) R1, RANK(3) WITHIN GROUP (ORDER BY V) R3, RANK(7) WITHIN GROUP (ORDER BY V) R7 FROM TEST;
SELECT RANK(1) WITHIN GROUP (ORDER BY V, V) FROM TEST;
SELECT RANK(1, 1) WITHIN GROUP (ORDER BY V, V + 1 DESC) R11, RANK(1, 2) WITHIN GROUP (ORDER BY V, V + 1 DESC) R12, RANK(1, 3) WITHIN GROUP (ORDER BY V, V + 1 DESC) R13 FROM TEST;
SELECT RANK(1, 1) WITHIN GROUP (ORDER BY V, V + 1) R11, RANK(1, 2) WITHIN GROUP (ORDER BY V, V + 1) R12, RANK(1, 3) WITHIN GROUP (ORDER BY V, V + 1) R13 FROM TEST;
...
SELECT REGR_AVGX(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
SELECT REGR_AVGY(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
SELECT REGR_COUNT(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
SELECT REGR_INTERCEPT(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
SELECT REGR_R2(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
SELECT REGR_SLOPE(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
SELECT REGR_SXX(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
SELECT REGR_SXY(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
SELECT REGR_SYY(Y, X) OVER (ORDER BY R) FROM (VALUES (1, NULL, 1), (2, 1, NULL), (3, NULL, NULL), (4, -3, -2), (5, -3, -1), (6, 10, 9), (7, 10, 10), (8, 10, 11), (9, 11, 7) ) T(R, Y, X) ORDER BY R;
...
SELECT ROUND(450359962737049.50::DOUBLE, 1), ROUND(450359962737049.55::DOUBLE, 1), ROUND(450359962737049.60::DOUBLE, 1), ROUND(450359962737049.70::DOUBLE, 1);
SELECT ROUND(4503599627370495.0::DOUBLE), ROUND(4503599627370495.5::DOUBLE), ROUND(4503599627370496.0::DOUBLE), ROUND(4503599627370497.0::DOUBLE);
SELECT ROUND(CUME_DIST(1) WITHIN GROUP (ORDER BY V), 2) R1, ROUND(CUME_DIST(3) WITHIN GROUP (ORDER BY V), 2) R3, ROUND(CUME_DIST(7) WITHIN GROUP (ORDER BY V), 2) R7 FROM TEST;
SELECT ROUND(N, -1) NN, ROUND(N) N0, ROUND(N, 1) N1, ROUND(N, 2) N2, ROUND(N, 3) N3, ROUND(N, 10000000) NL, ROUND(D) D0, ROUND(D, 2) D2, ROUND(D, 3) D3, ROUND(I) I0, ROUND(I, 1) I1, ROUND(I, I) II FROM T1;
SELECT ROUND(PERCENT_RANK(1) WITHIN GROUP (ORDER BY V), 2) R1, ROUND(PERCENT_RANK(3) WITHIN GROUP (ORDER BY V), 2) R3, ROUND(PERCENT_RANK(7) WITHIN GROUP (ORDER BY V), 2) R7 FROM TEST;
...
SELECT ROW_NUMBER() OVER (ORDER BY CATEGORY) RN, RANK() OVER (ORDER BY CATEGORY) RK, DENSE_RANK() OVER (ORDER BY CATEGORY) DR, PERCENT_RANK() OVER () PR, CUME_DIST() OVER () CD, CATEGORY C FROM TEST GROUP BY CATEGORY ORDER BY RN;
...
SELECT S, CASE S WHEN IS NULL THEN 1 WHEN LOWER('A') THEN 2 WHEN LIKE '%b' THEN 3 WHEN ILIKE 'C' THEN 4 WHEN REGEXP '[dQ]' THEN 5 WHEN IS NOT DISTINCT FROM 'e' THEN 6 WHEN IN ('x', 'f') THEN 7 WHEN IN (VALUES 'g', 'z') THEN 8 WHEN BETWEEN 'h' AND 'i' THEN 9 WHEN = 'j' THEN 10 WHEN < ANY(VALUES 'j', 'l') THEN 11 WHEN NOT LIKE '%m%' THEN 12 WHEN IS OF (VARCHAR) THEN 13 ELSE 13 END FROM (VALUES NULL, 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm') T(S);
...
SELECT SUM(ID) OVER (ORDER BY ID RANGE BETWEEN 10000000000 PRECEDING AND CURRENT ROW) P, SUM(ID) OVER (ORDER BY ID RANGE BETWEEN 10000000001 PRECEDING AND 10000000000 PRECEDING) P2, SUM(ID) OVER (ORDER BY ID RANGE BETWEEN CURRENT ROW AND 2147483647 FOLLOWING) F, SUM(ID) OVER (ORDER BY ID RANGE BETWEEN 2147483647 FOLLOWING AND 2147483648 FOLLOWING) F2, ID FROM TEST ORDER BY ID;
...
SELECT SUM(points) FROM RESULTS WHERE eventID IN (SELECT eventID FROM RESULTS WHERE studentID = 2 ORDER BY points DESC LIMIT 2 ) AND studentID = 2;
SELECT SUM(r.points) FROM RESULTS r, (SELECT eventID FROM RESULTS WHERE studentID = 2 ORDER BY points DESC LIMIT 2 ) r2 WHERE r2.eventID = r.eventId AND studentID = 2;
SELECT SYSTEM_USER;
...
SELECT T1.*, T2.* FROM (VALUES(1, 'A'), (2, 'B')) T1(A, B) RIGHT JOIN (VALUES(2, 'C'), (3, 'D')) T2(A, C) USING (A);
...
SELECT T1.A, T2.ARR FROM TEST T1 JOIN ( SELECT A, ARRAY_AGG(B) OVER (ORDER BY B ROWS BETWEEN 1 FOLLOWING AND 2 FOLLOWING) ARR FROM TEST ) T2 ON T1.A = T2.A;
SELECT T1.B, T2.B FROM T1 INNER JOIN T2 USING (A);
SELECT T1.B, T2.B FROM T1 INNER JOIN T2 USING (A, B);
SELECT T1.C1, T2.C5 FROM TEST T1 JOIN ( SELECT DISTINCT ON(C1) C1, C4, C5 FROM TEST ORDER BY C1, C5 ) T2 ON T1.C4 = T2.C4 ORDER BY T1.C1;
SELECT T1.C1, T2.C5 FROM TEST T1 JOIN ( SELECT DISTINCT ON(C1) C1, C4, C5 FROM TEST ORDER BY C1, C5 DESC ) T2 ON T1.C4 = T2.C4 ORDER BY T1.C1;
SELECT T1.ID, T2.V AS LV FROM (SELECT ID, MAX(V) AS LV FROM T GROUP BY ID) AS T1 INNER JOIN T AS T2 ON T2.ID = T1.ID AND T2.V = T1.LV WHERE T1.ID IN (1, 2) ORDER BY ID;
SELECT T1.X1, T2.X2, T3.X3, T4.X4, T5.X5 FROM ( T1 INNER JOIN ( T2 LEFT OUTER JOIN ( T3 INNER JOIN T4 ON T3.X3 = T4.X4 ) ON T2.X2 = T4.X4 ) ON T1.X1 = T2.X2 ) INNER JOIN T5 ON T2.X2 = T5.X5;
...
SELECT TABLE_NAME, NUMERIC_PRECISION, DECLARED_NUMERIC_PRECISION FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'PUBLIC';
SELECT TABLE_NAME, ROW_COUNT_ESTIMATE FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'INFORMATION_SCHEMA' AND TABLE_NAME IN ('INFORMATION_SCHEMA_CATALOG_NAME', 'SCHEMATA', 'ROLES', 'SESSIONS', 'IN_DOUBT', 'USERS');
...
SELECT TEST1.ID, TEST2.ID, TEST3.ID FROM TEST2 LEFT OUTER JOIN TEST3 ON TEST2.ID = TEST3.ID INNER JOIN TEST1 WHERE TEST3.ID IS NULL AND TEST1.ID = TEST2.ID;
SELECT TIME '1122';
SELECT TIME '1122.1';
SELECT TIME '112233';
...
SELECT TIMESTAMP WITH TIME ZONE '2000-01-10 00:00:00 -02' AS A, TIMESTAMP WITH TIME ZONE '2000-01-10 00:00:00.000000000 +02:00' AS B, TIMESTAMP WITH TIME ZONE '2000-01-10 00:00:00.000000000+02:00' AS C, TIMESTAMP WITH TIME ZONE '2000-01-10T00:00:00.000000000+09:00[Asia/Tokyo]' AS D;
...
SELECT TRUNC(N, -1) NN, TRUNC(N) N0, TRUNC(N, 1) N1, TRUNC(N, 2) N2, TRUNC(N, 3) N3, TRUNC(N, 10000000) NL, TRUNC(D) D0, TRUNC(D, 2) D2, TRUNC(D, 3) D3, TRUNC(I) I0, TRUNC(I, 1) I1, TRUNC(I, I) II FROM T1;
...
SELECT U1.TABLE_NAME T1, U1.COLUMN_NAME C1, U2.TABLE_NAME T2, U2.COLUMN_NAME C2 FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE U1 JOIN INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS RC ON U1.CONSTRAINT_NAME = RC.CONSTRAINT_NAME JOIN INFORMATION_SCHEMA.KEY_COLUMN_USAGE U2 ON RC.UNIQUE_CONSTRAINT_NAME = U2.CONSTRAINT_NAME AND U1.POSITION_IN_UNIQUE_CONSTRAINT = U2.ORDINAL_POSITION WHERE U1.CONSTRAINT_NAME = 'FK_2' ORDER BY U1.COLUMN_NAME;
...
SELECT V, BITNOT(BIT_AND_AGG(V) FILTER (WHERE V > 0) OVER (PARTITION BY BITAND(V, 7) ORDER BY V)) G, BIT_NAND_AGG(V) FILTER (WHERE V > 0) OVER (PARTITION BY BITAND(V, 7) ORDER BY V) C FROM TEST;
SELECT V, CASE V WHEN IN(CURRENT_DATE, DATE '2010-01-01') THEN 1 ELSE 2 END FROM (VALUES DATE '2000-01-01', DATE '2010-01-01', DATE '2020-02-01') T(V);
SELECT V, SUM(V) FILTER (WHERE V <> 1) OVER (ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) S, SUM(V) FILTER (WHERE V <> 1) OVER (ROWS BETWEEN UNBOUNDED PRECEDING AND 1 FOLLOWING) T FROM (VALUES 1, 2, 2) T(V);
...
SELECT X BETWEEN A AND B A1, X BETWEEN ASYMMETRIC A AND B A2, A <= X AND X <= B A3, X BETWEEN SYMMETRIC A AND B S1, A <= X AND X <= B OR A >= X AND X >= B S2, X NOT BETWEEN A AND B NA1, X NOT BETWEEN ASYMMETRIC A AND B NA2, NOT (A <= X AND X <= B) NA3, X NOT BETWEEN SYMMETRIC A AND B NS1, NOT (A <= X AND X <= B OR A >= X AND X >= B) NS2 FROM TEST ORDER BY ID;
...
SELECT X, A, ROW_NUMBER() OVER (ORDER BY B) R FROM (SELECT 1 X), (VALUES (1, 2), (2, 1), (3, 3)) T(A, B);
...
SELECT X.A, Y.B, Z.C FROM (SELECT 1 A) X JOIN ( (SELECT 1 B) Y JOIN (SELECT 1 C) Z ON Z.C = Y.B ) ON Y.B = X.A;
...
SELECT _ROWID_ S1, TEST._ROWID_ S2, PUBLIC.TEST._ROWID_ S3, SCRIPT.PUBLIC.TEST._ROWID_ S4, "_ROWID_" U1, TEST."_ROWID_" U2, PUBLIC.TEST."_ROWID_" U3, SCRIPT.PUBLIC.TEST."_ROWID_" U4 FROM TEST;
SELECT _ROWID_, A FROM TEST WHERE B = 4;
SELECT _ROWID_, ID FROM TEST;
SELECT count(*) FROM test_null WHERE not ('X'=null and 1=0);
SELECT eventID X FROM RESULTS WHERE studentID = 2 ORDER BY points DESC LIMIT 2;
...
SELECT table_c.center_id, table_a.a_id, table_b.b_id FROM table_c INNER JOIN table_a ON table_c.left_id = table_a.left_id AND table_c.right_id = table_a.right_id LEFT JOIN table_b ON table_b.a_id = table_a.a_id;
SELECT;
...
select * from (select dir_num, count(*) as cnt from multi_pages t, b_holding bh where t.bh_id=bh.id and bh.site='Hello' group by dir_num) as x where cnt < 1000 order by dir_num asc;
...
select * from one natural join two left join one four on two.id=four.id left join two three on one.id=three.id where three.val is null or three.val>=DATE'2006-07-01';
select * from one natural join two left join two three on one.id=three.id left join one four on two.id=four.id where three.val is null or three.val>=DATE'2006-07-01';
select * from one natural join two left join two three on one.id=three.id left join one four on two.id=four.id where three.val is null;
select * from one natural join two left join two three on one.id=three.id left join one four on two.id=four.id where three.val>=DATE'2006-07-01';
...
select * from system_range(1, 2) a, (select * from system_range(1, 2) union select * from system_range(1, 2) union select * from system_range(1, 1)) v where a.x = v.x;
...
select * from system_range(2, 100) r where not exists(select * from system_range(2, 11) r2 where r.x>r2.x and mod(r.x, r2.x)=0);
...
select * from test l0 inner join test l1 on l0.sid=l1.sid inner join test l2 on l0.sid=l2.id, test l5 inner join test l3 on l5.sid=l3.sid inner join test l4 on l5.sid=l4.id where l2.id is not null and l0.sid=l5.parent;
...
select * from test t1 inner join test t2 on t2.id=t1.id inner join test t3 on t3.id=t2.id where exists (select 1 from test t4 where t2.id=t4.id);
...
select * from test1 inner join test2 on test1.id=test2.id left outer join test3 on test2.id=test3.id where test3.id is null;
...
select ARRAY_AGG(v order by v asc), ARRAY_AGG(v order by v desc) filter (where v >= '4') from test where v >= '2';
select ARRAY_AGG(v order by v asc), ARRAY_AGG(v order by v desc) filter (where v >= '4') from test;
...
select degrees(null) vn, truncate(degrees(1), 10) v1, truncate(degrees(1.1), 10) v2, truncate(degrees(-1.1), 10) v3, truncate(degrees(1.9), 10) v4, truncate(degrees(-1.9), 10) v5;
select dept, median(amount) filter (where amount >= 20) from test group by dept order by dept;
select dept, median(amount) filter (where amount >= 20) from test where (amount < 200) group by dept order by dept;
...
select dir_num, count(*) as cnt from multi_pages t, b_holding bh where t.bh_id=bh.id and bh.site='Hello' group by dir_num having count(*) < 1000 order by dir_num asc;
...
select family, (select count(car) from cars where cars.family = people.family) as x from people group by family order by family;
...
select group_concat(id order by id) from test;
select group_concat(v order by v asc separator '-'), group_concat(v order by v desc separator '-') filter (where v >= '4') from test where v >= '2';
select group_concat(v order by v asc separator '-'), group_concat(v order by v desc separator '-') filter (where v >= '4') from test;
...
select listagg(v, '-') within group (order by v asc), listagg(v, '-') within group (order by v desc) filter (where v >= '4') from test where v >= '2';
...
select percentile_cont(0.05) within group (order by v) c05a, percentile_cont(0.05) within group (order by v desc) c05d, percentile_cont(0.5) within group (order by v) c50, percentile_cont(0.5) within group (order by v desc) c50d, percentile_cont(0.95) within group (order by v) c95a, percentile_cont(0.95) within group (order by v desc) c95d, g from test group by g;
select percentile_cont(0.16) within group (order by v) from test;
select percentile_disc(0.05) within group (order by v) d05a, percentile_disc(0.05) within group (order by v desc) d05d, percentile_disc(0.5) within group (order by v) d50, percentile_disc(0.5) within group (order by v desc) d50d, percentile_disc(0.95) within group (order by v) d95a, percentile_disc(0.95) within group (order by v desc) d95d from test;
select percentile_disc(0.05) within group (order by v) d05a, percentile_disc(0.05) within group (order by v desc) d05d, percentile_disc(0.5) within group (order by v) d50, percentile_disc(0.5) within group (order by v desc) d50d, percentile_disc(0.95) within group (order by v) d95a, percentile_disc(0.95) within group (order by v desc) d95d, g from test group by g;
select percentile_disc(0.05) within group (order by v) over (partition by g order by v) d05a, percentile_disc(0.05) within group (order by v desc) over (partition by g order by v) d05d, percentile_disc(0.5) within group (order by v) over (partition by g order by v) d50, percentile_disc(0.5) within group (order by v desc) over (partition by g order by v) d50d, percentile_disc(0.95) within group (order by v) over (partition by g order by v) d95a, percentile_disc(0.95) within group (order by v desc) over (partition by g order by v) d95d, g, v from test order by g, v;
select percentile_disc(0.5) within group (order by v) d50a, percentile_disc(0.5) within group (order by v desc) d50d, median(v) m from test;
select pi();
...
select radians(null) vn, truncate(radians(1), 10) v1, truncate(radians(1.1), 10) v2, truncate(radians(-1.1), 10) v3, truncate(radians(1.9), 10) v4, truncate(radians(-1.9), 10) v5;
select rand();
...
select soundex('Washington') W252, soundex('Lee') L000, soundex('Gutierrez') G362, soundex('Pfister') P236, soundex('Jackson') J250, soundex('Tymczak') T522, soundex('VanDeusen') V532, soundex('Ashcraft') A261;
...
select stddev_pop(distinct x) s_px, stddev_samp(distinct x) s_sx, var_pop(distinct x) v_px, var_samp(distinct x) v_sx, stddev_pop(distinct y) s_py, stddev_samp(distinct y) s_sy, var_pop(distinct y) v_py, var_samp(distinct y) V_SY from t;
select stddev_pop(x) s_px, stddev_samp(x) s_sx, var_pop(x) v_px, var_samp(x) v_sx, stddev_pop(y) s_py, stddev_samp(y) s_sy, var_pop(y) v_py, var_samp(y) v_sy from t;
...
select sum(x) from system_range(2, 1000) r where not exists(select * from system_range(2, 32) r2 where r.x>r2.x and mod(r.x, r2.x)=0);
