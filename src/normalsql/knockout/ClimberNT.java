...
ClimberNT
{
    ...
    public ClimberNT( Parser parser, CommonTokenStream tokens )
    {
        this.parser = parser;
        this.tokens = tokens;
        stack.add( trunk );
...
//            switch( child )
//            {
//                case ItemAllContext ignore ->
//                {
//                    top.items.add( new ItemAll() );
//                    continue;
//                }
//                case ItemColumnContext ignore ->
//                {
//                    top.items.add( new ItemColumn() );
//                }
//            }
//
